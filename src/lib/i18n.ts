...
const dict: Record<string, { zh: string; en: string }> = {
  ...
  // ── P2P 群聊 ──
  p2pTitle: { zh: 'P2P 群聊', en: 'P2P Group Chat' },
  p2pCreateInvite: { zh: '创建邀请', en: 'Create Invite' },
  p2pJoinRoom: { zh: '加入房间', en: 'Join Room' },
  p2pPasteToken: { zh: '粘贴邀请票据…', en: 'Paste invite token…' },
  p2pJoin: { zh: '加入', en: 'Join' },
  p2pCopy: { zh: '复制', en: 'Copy' },
  p2pCopied: { zh: '已复制', en: 'Copied' },
  p2pDisconnect: { zh: '断开', en: 'Disconnect' },
  p2pEnterChat: { zh: '进入群聊', en: 'Enter Chat' },
  p2pMembers: { zh: '成员', en: 'Members' },
  p2pComputeNode: { zh: '算力端', en: 'Compute node' },
  p2pTabSolo: { zh: '单聊', en: 'Solo' },
  p2pTabGroup: { zh: '群聊', en: 'Group' },
  p2pSend: { zh: '发送', en: 'Send' },
  p2pInputPlaceholder: { zh: '说点什么…', en: 'Say something…' },
  p2pBorrowCompute: { zh: '借算力', en: 'Borrow Compute' },
  p2pComputePlaceholder: { zh: '输入 prompt，借桌面端算力…', en: 'Enter prompt to borrow desktop compute…' },
  p2pCancel: { zh: '取消', en: 'Cancel' },
  p2pRetry: { zh: '重试', en: 'Retry' },
  p2pRelayLabel: { zh: 'P2P Relay 地址', en: 'P2P Relay URL' },
  p2pRelayHint: { zh: '默认 ws://127.0.0.1:8081，公网用 wss://', en: 'Default ws://127.0.0.1:8081; use wss:// for public' },
  p2pConnecting: { zh: '连接中…', en: 'Connecting…' },
  p2pJoined: { zh: '已连接', en: 'Connected' },
  p2pDisconnected: { zh: '已断开', en: 'Disconnected' },
  p2pReconnectFailed: { zh: '重连失败，请手动重连', en: 'Reconnect failed, retry manually' },
