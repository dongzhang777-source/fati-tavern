...
const dict: Record<string, { zh: string; en: string; ja: string; ko: string }> = {
  ...
  'share.confirmTitle': {
    zh: '来自分享链接的角色卡',
    en: 'Card from a share link',
    ja: '共有リンクのキャラカード',
    ko: '공유 링크로 받은 캐릭터 카드',
  },
  'share.confirmBody': {
    zh: '将「{name}」加入你的角色库？只导入你信任的人分享的卡片。',
    en: 'Add "{name}" to your library? Only import cards from people you trust.',
    ja: '「{name}」をライブラリに追加しますか？信頼できる人から共有されたカードだけを取り込んでください。',
    ko: '"{name}"을(를) 라이브러리에 추가할까요? 신뢰할 수 있는 사람이 공유한 카드만 가져오세요.',
  },
  'share.confirmOk': { zh: '导入', en: 'Import', ja: 'インポート', ko: '가져오기' },
  'share.confirmCancel': { zh: '忽略', en: 'Dismiss', ja: '破棄', ko: '무시' },
